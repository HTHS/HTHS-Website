	<? if(!isset($nosidebar)): ?>	
		<div id="sidebar">
			<div class="fancybox">
				<a href="<?=site_url('teacher_dashboard')?>" class="button_link">>> Home</a>
				<a href="<?=site_url('teacher_dashboard/change_password')?>" class="button_link">>> Change Password</a>             
				<a href="<?=site_url('teacher_dashboard/logout')?>" class="button_link">>> Logout</a>
			</div> 
			<div class="fancybox">
