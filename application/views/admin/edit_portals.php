...
$(function() {
	...
	$.getJSON('<?=site_url('admin/edit_portals/get')?>', function(data) {
	...
	$('#menueditor_submit > .menueditor_button').click(function() {
		...
		$.post('<?=site_url('admin/edit_portals/save')?>', data, function(info) {
			alert(info);
		});
		return false;
	});
...
<div class="fancybox">
	<h2 class="fancytitle">Portal Editor</h2>
	<p>Only links in the first menu item will be displayed, all others will be ignored!</p>
	...
	<div id="menueditor_submit"><a class="menueditor_button" href="#">Save Portals</a></div>
</div>
</div>
</div>